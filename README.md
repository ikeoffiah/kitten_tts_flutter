...
> `bash "$(flutter pub cache path)/hosted/pub.dev/flutter_kitten_tts-0.1.1/scripts/setup_espeak.sh"`  
> (Replace `0.1.1` with your installed version, or for a git dependency use `.../git/kitten_tts_flutter-*/scripts/setup_espeak.sh`.) This downloads espeak-ng 1.52.0 into `third_party/espeak-ng/`.
